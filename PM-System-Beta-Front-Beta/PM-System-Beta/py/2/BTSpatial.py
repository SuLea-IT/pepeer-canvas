...
if os.path.exists(gene_id_file_path):
    ...
    for idx, gene_id in enumerate(gene_ids):
        ...
        save_figure(adata, gene_id, save_path, f'spatial_bin_gene_projection_{gene_id}', plot_type='umap')
        save_figure(adata, gene_id, save_path, f'spatial_bin_dotplot_gene_projection_{gene_id}', plot_type='dotplot')
        save_figure(adata, gene_id, save_path, f'spatial_bin_spatial_projection_{gene_id}', plot_type='spatial',Finally=is_last)
